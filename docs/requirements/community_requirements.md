...
|                       | Post 본인만 수정 | 로그인한 사용자는 자신이 작성한 포스트만 수정할 수 있다. | 기능 | 1 |
|                       | Post 삭제 | 사용자는 필요한 정보를 전달하여 포스트를 삭제할 수 있다. | 기능 | 1 |
|                       | Post 삭제 권한 | 로그인한 사용자만이 포스트를 삭제할 수 있다. | 기능 | 1 |
|                       | Post 본인만 삭제 | 로그인한 사용자는 자신이 작성한 포스트만 삭제할 수 있다. | 기능 | 1 |
...
|                       | Comment 본인만 수정 | 로그인한 사용자는 자신이 작성한 Comment만 수정할 수 있다. | 기능 | 1 |
...
| SubComment            | SubComment 생성 | 사용자는 Comment에 SubComment를 생성할 수 있다. | 기능 | 1 |
...
|                       | SubComment 본인만 수정 | 로그인한 사용자는 자신이 작성한 SubComment만 수정할 수 있다. | 기능 | 1 |
|                       | SubComment 삭제 | 사용자는 SubComment를 삭제할 수 있다. | 기능 | 1 |
|                       | SubComment 삭제 권한 | 로그인한 사용자만이 SubComment를 삭제할 수 있다. | 기능 | 1 |
|                       | SubComment 본인만 삭제 | 로그인한 사용자는 자신이 작성한 SubComment만 삭제할 수 있다. | 기능 | 1 |